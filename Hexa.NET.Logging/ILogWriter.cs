namespace Hexa.NET.Logging
{
    ...
    public interface ILogWriter : IDisposable
    {
        ...
        {
            WriteLine($"{message.Timestamp:t} [{message.Severity}] [{message.Logger.Name}] {message.Message}");
        }
        ...
        {
            await WriteLineAsync($"{message.Timestamp:t} [{message.Severity}] [{message.Logger.Name}] {message.Message}");
        }
